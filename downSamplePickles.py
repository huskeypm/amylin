...
def downsample(fileName,rate=10,fileOutName=None): 
  dataFull = ao.readPickle(fileName,verbose=False)
  ...
  if fileOutName==None:
    redFileName = fileName.replace(".pkl","_red.pkl")
  else: 
    redFileName = fileOutName
  #print "redFileName: ", redFileName 
